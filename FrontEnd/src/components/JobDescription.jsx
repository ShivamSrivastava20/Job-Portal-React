...
import { APPLICATION_API_ADDRESS, JOB_API_ADDRESS } from "@/utils/constant";
...
const JobDescription = () => {
  ...
  const isInitaillayApplied =
    singleJob?.applications?.some(
      (application) => application.applicant === user?._id
    ) || false;
  const [isApplied, setIsApplied] = useState(isInitaillayApplied);
  ...
  const applyJobHandler = async () => {
    try {
      const res = await axios.get(`${APPLICATION_API_ADDRESS}/apply/${jobId}`, {
